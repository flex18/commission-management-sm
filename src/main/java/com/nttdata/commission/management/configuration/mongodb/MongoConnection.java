package com.nttdata.commission.management.configuration.mongodb;
...
@Configuration
@EnableReactiveMongoRepositories(basePackages = "com.nttdata.commission.management.repository")
public class MongoConnection extends AbstractReactiveMongoConfiguration{
    ...
    public Collection<String> getMappingBasePackages() {
       return Collections.singleton("com.nttdata.commission.management");
    }
